...
public class signinIncome extends javax.swing.JFrame {
...
//                    System.out.println(fname + "  Login successfully");
                    ...
                    income_Salary incomeSalary = new income_Salary(nic,fname);
                    incomeSalary.setVisible(true);
                    this.dispose();

                } else {
                    JOptionPane.showMessageDialog(this, "Invalid Email /Password OR you Are Not Valid Admin !", "Warning", JOptionPane.WARNING_MESSAGE);
                }
            } catch (Exception e) {
                e.printStackTrace();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new signinIncome().setVisible(true);
            }
        });
    }
