...
public class Mailer_login extends javax.swing.JFrame {
        ...
        if (Nic.isEmpty()) {
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    Mail_sending mail_sending = new Mail_sending();
                    mail_sending.setVisible(true);
                    this.dispose();
                } else {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Mailer_login().setVisible(true);
            }
        });
    }
