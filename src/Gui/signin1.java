...
public class signin1 extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (email.isEmpty()) {
            ...
            try {
                ResultSet rs = MYSQL.executeSearch("SELECT * FROM `student` WHERE `email` = '" + email + "' AND `mobile`='" + mobile + "' ");
                ...
                if (rs.next()) {
                    ...
                    String stmobile = rs.getString("mobile");

                    StudentProfile studentProfile = new StudentProfile(stemail, fname, lname, stmobile);
