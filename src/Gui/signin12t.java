...
public class signin12t extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (email.isEmpty()) {
            ...
            try {
                ResultSet rs = MYSQL.executeSearch("SELECT * FROM `teacher` WHERE `email` = '" + email + "' AND `mobile`='" + mobile + "' ");
                ...
                if (rs.next()) {
                    ...
                    String teachermobile = rs.getString("mobile");
                    String nic = rs.getString("nic");
                    
//                    System.out.println(fname + "  Login successfully");

                    timetableTeacher timetableSeter = new timetableTeacher(nic,fname);
                    timetableSeter.setVisible(true);
                    this.dispose();
